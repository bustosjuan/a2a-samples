...
from a2a.types import Message, TextPart, MessageSendParams, SendStreamingMessageRequest
...
async def proxy_request(request: Request):
    ...
    try:
        ...
        if 'message' in body and body.get('message'):
            ...
            return StreamingResponse(stream_proxy(response_stream, httpx_client), media_type="text/event-stream")
